...
import MoodTrackingView from "./mood-tracking.tsx";
import SleepTrackingView from "./sleep-tracking.tsx";
...
export default function GrowthTracking() {
  ...
  // If a sub-tab is active, show that view
  if (activeSubTab === "mood") {
    return (
      <div className="space-y-6">
        <Button
          variant="ghost"
